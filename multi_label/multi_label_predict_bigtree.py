...
for a in range(len(df1)):
    ...
    val.append((df1['id'][a] , '-' , df1['title'][a] , df1['type'][a] , df1['content'][a] , df1['date'][a] , '-' ,'-' ,'-' ,df1['url'][a] ,df1['source'][a] , df1['predict_tag'][a] , df1['scoreFET'][a] ,df1['scoreCHT'][a] , df1['scoreTWN'][a] , df1['scoreGT'][a] , df1['scoreTWNS'][a] ,d1 ))
